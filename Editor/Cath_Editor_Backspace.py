    ...
    # Otherwise act as normal
        ...
        if self.pos < 1 and self.current_line > 1:
            ...
            if self.rock_bottom == 0 and self.only_display == 0:
                ...
                # Fix display of new current line
                self.display_lines[self.display_current_line - 1] = self.lines[self.current_line - 1]
            ...
            # Otherwise take lines away from top of file by bringing them down one spot
                ...
                # Display all lines from ground up
                for l in range(self.bottom, self.bottom - self.max_lines, -1):
                    self.display_lines[l - self.real - 1] = self.lines[l - 1]
                ...
                # Else amount of lines in 'file list' is less than amount of lines able to be
                # displayed so just make displayed lines the same as 'file list' lines
